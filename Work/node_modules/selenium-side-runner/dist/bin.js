...
program
    ...
    .option('-o, --output-directory [it directory]', 'Write test results as json to file in specified directory. Name will be based on timestamp.')
...
const jest = resolve_bin_1.default.sync('jest');
const jestArgs = [
    '--config=' + path_1.default.join(__dirname, '..', 'jest.config.js'),
