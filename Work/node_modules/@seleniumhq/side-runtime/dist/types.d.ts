...
export declare type OnCommandRecordedResult = void | onCommandRecordedDropResult | OnCommandRecordedUpdateResult;
export declare type PluginHookInput = {
    logger: Console;
...
export interface PluginPreloadOutputShape {
    hooks: {
        onCommandRecorded?: (command: NewCommandShape, event: Event | KeyboardEvent | MouseEvent | MutationRecord[] | undefined) => OnCommandRecordedResult;
    };
}
export declare type SendMessage = (...args: any[]) => void;
export declare type PluginPreloadShape = (sendMessage: SendMessage) => PluginPreloadOutputShape;
