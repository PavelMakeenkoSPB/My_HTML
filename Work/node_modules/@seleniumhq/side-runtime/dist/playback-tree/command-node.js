...
exports.CommandType = exports.CommandNode = void 0;
    ...
    */
    ...
    async _executeCommand(commandExecutor, { executorOverride } = {}) {
        if (executorOverride) {
            ...
            const ignoreRetry = commandName === 'pause' || commandName.startsWith('wait');
            if (ignoreRetry) {
                return executor();
            }
    ...
    async retryCommand(execute, timeout) {
    ...
    _evaluate(commandExecutor) {
        ...
        else if (commands_1.ControlFlowCommandChecks.isForEach(this.command)) {
